function SubmitForm(){
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            sendMailRegistration(response.name,response.username,response.password,response.companyEmail)
...
function sendMailRegistration(name,username,password,emailID) {
